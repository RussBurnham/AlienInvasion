...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        # Update bullet positions and rid of bullets that have gone off the screen.
        self.bullets.update()
        for bullet in self.bullets.copy():
            if (bullet.rect.x > self.settings.screen_width or 
            bullet.rect.x < 0 or 
            bullet.rect.y > self.settings.screen_height or 
            bullet.rect.y < 0):
    ...
    def _update_aliens(self):
        '''Check if alien fleet at edge, then update the positions of aliens.'''
