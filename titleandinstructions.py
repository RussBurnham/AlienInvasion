...
class Title:
    ...
    def __init__(self, ai_game, text):
        ...
        self.font = pygame.font.Font('C:/Users/User/3D Objects/code.ttf', 52)
...
class Instructions:
    ...
    def __init__(self, ai_game, text):
        ...
        # Split the text into separate strings.
